...
echo	'<table cellpadding="0" cellspacing="0" border="0" width="'.$tblWidth.'" align="center">
			<tr>
				<th class="ft_head">&nbsp;</th>
				<th class="ft_head'.$ft_sel_cur.'"><a href="./?module=primetime&s=curweek">This Week</a></th>
				<th class="ft_head'.$ft_sel_7.'"><a href="./?module=primetime&s=lst7">Last 7 Days</a></th>
				<th class="ft_head'.$ft_sel_30.'"><a href="./?module=primetime&s=lst30">Last 30 Days</a></th>
			</tr>
		</table>';
